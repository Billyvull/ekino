...
<head itemscope itemtype="http://schema.org/WPHeader">
    ...
    <meta itemprop="keywords" name="keywords" content="Фантастика без рекламы, Ютуб Фантастика, Фантастика фильмы 2021, смотреть онлайн, фильмы бесплатно">
    <meta itemprop="description" name="description" content="<?php 
        if(isset($_GET['page'])){ 
            echo 'Смотреть '. ((int) $_GET['page'])*25 .'+ ютуб фильмов в жанре Фантастика без рекламы 2021 года. Мы отобрали самые недооцененные фильмы, которые стоит посмотреть всем любителям жанра Фантастика. Просмотр полностью бесплатный!' ;}
        else { 
            echo 'Смотреть 100+ ютуб фильмов в жанре Фантастика без рекламы 2021 года. Мы отобрали самые недооцененные фильмы, которые стоит посмотреть всем любителям жанра Фантастика. Просмотр полностью бесплатный!' ; }?>">
<!------------------------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------------------------>
    ...
    <link rel="shortcut icon" href="/img/favpuh.ico" type="image/x-icon">
            <!--------------------------------------------------------------------------------------->   
                 <meta property="og:title" content="Ютуб Фантастика 🎬 eKino" />
                 <meta property="og:type" content="article">
                 <meta property="og:url" content="https://ekino.me/fantastika" />
...
<!---------------------------------------------------- require: H1 ----------------------------------------------------->
            <h1>
                <?php 
                 if(isset($_GET['page'])){
                 echo 'Ютуб Фантастика <sup style="font-size: 16px;color: #ccc;">(Топ '. ((int) $_GET['page'])*25 .')</sup>' ;
                 }
                 else {
                 echo 'Ютуб Фантастика' ;
                 }
                ?>
            </h1>
<!---------------------------------------------------------------------------------------------------------------------->
...
<!------------------------------------------------------------------------------------------------------------------------>
    <ul class="films__list" itemscope itemtype="http://schema.org/ItemList">
        <?php $singles = Фантастика(); foreach ($singles as $single) { ?>
...
<!------------------------------------------------------------------------------------------------------------------------>
    ...
    <!-- ПАГИНАЦИЯ -->
    <?php $singles = category_pagination(); foreach ($singles as $single) { ?><?php echo $single["fantastika"]; ?> <?php } ?>
    <!--------------->
            <div class="about">
                <h2>Фантастика без рекламы</h2>
                <div class="about__description">
                  <p class="about__description_content">
                     Если вы ищете фильмы ютуб без рекламы в жанре фантастика, тогда добро пожаловать на eKino!
                     Сайт где собрана наибольшая подборка фантастических фильмов без надоедливой рекламы.
                     Для просмотра которых не нужно устанавливать блокировщики рекламы
                     или подобные программы удаления рекламных объявлений.
                 </p>
                 <br>
                  <p class="about__description_content">
                      Уже посмотрели все фильмы фантастики и не можете найти хорошее кино?
                      Мы отбираем самые недооцененные фильмы, которые вы захотите посмотреть.
                  </p>
                <h3>В хорошем качестве</h3>
                   <p class="about__description_content">
                       Сейчас на сайте много фильмов жанра фантастика, которые стоит посмотреть каждому.
                   ...
                   <br>
                   <p class="about__description_content">
                       eKino публикует фильмы фантастики только в хорошем качестве: HD 720 и Full HD 1080.
