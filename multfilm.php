...
<head itemscope itemtype="http://schema.org/WPHeader">
    ...
    <meta itemprop="keywords" name="keywords" content="Мультфильмы без рекламы, Ютуб Мультфильмы, мультфильмы 2021, смотреть онлайн, мультфильмы бесплатно">
    <meta itemprop="description" name="description" content="<?php 
        if(isset($_GET['page'])){ 
            echo 'Смотреть '. ((int) $_GET['page'])*25 .'+ ютуб мультфильмы без рекламы 2021 года. Мы отобрали самые недооцененные мультфильмы, которые стоит посмотреть всем любителям данного жанра. Просмотр полностью бесплатный!' ;}
        else { 
            echo 'Смотреть 100+ ютуб мультфильмов без рекламы 2021 года. Мы отобрали самые недооцененные мультфильмы, которые стоит посмотреть всем любителям данного жанра. Просмотр полностью бесплатный!' ; }?>">
<!------------------------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------------------------>
    ...
    <link rel="shortcut icon" href="/img/favpuh.ico" type="image/x-icon">
            <!--------------------------------------------------------------------------------------->   
                 <meta property="og:title" content="Ютуб Мультфильмы 🎬 eKino" />
                 <meta property="og:type" content="article">
                 <meta property="og:url" content="https://ekino.me/multfilm" />
...
<!---------------------------------------------------- require: H1 ----------------------------------------------------->
            <h1>
                <?php 
                 if(isset($_GET['page'])){
                 echo 'Ютуб Мультфильмы <sup style="font-size: 16px;color: #ccc;">(Топ '. ((int) $_GET['page'])*25 .')</sup>' ;
                 }
                 else {
                 echo 'Ютуб Мультфильмы' ;
                 }
                ?>
            </h1>
<!---------------------------------------------------------------------------------------------------------------------->
...
<!------------------------------------------------------------------------------------------------------------------------>
    <ul class="films__list" itemscope itemtype="http://schema.org/ItemList">
        <?php $singles = Мультфильм(); foreach ($singles as $single) { ?>
...
<!------------------------------------------------------------------------------------------------------------------------>
    ...
    <!-- ПАГИНАЦИЯ -->
    <?php $singles = category_pagination(); foreach ($singles as $single) { ?><?php echo $single["multfilm"]; ?> <?php } ?>
    <!--------------->
            <div class="about">
                <h2>Мультфильмы без рекламы</h2>
                <div class="about__description">
                  <p class="about__description_content">
                     Если вы ищете мультфильмы ютуб без рекламы, тогда добро пожаловать на eKino!
                     Сайт где собрана наибольшая подборка мультфильмов без надоедливой рекламы.
                     Для просмотра которых не нужно устанавливать блокировщики рекламы
                     или подобные программы удаления рекламных объявлений.
                 </p>
                 <br>
                  <p class="about__description_content">
                      Уже посмотрели все мультфильмы и не можете найти хорошее мультпремьеру?
                      Мы отбираем самые недооцененные фильмы, которые вы захотите посмотреть.
                  </p>
                <h3>В хорошем качестве</h3>
                   <p class="about__description_content">
                       Сейчас на сайте много мультфильмов, которые стоит посмотреть каждому.
                       Множество из этих мультфильмов получают высокую оценку от пользователей.
                       Это помогает развивать сайт и добавлять больше мультфильмов без рекламы.
                   </p>
                   <br>
                   <p class="about__description_content">
                       eKino публикует мультфильмы только в хорошем качестве: HD 720 и Full HD 1080.
                       Со встроенным и удобным видео-плеером от YouTube. Благодаря которому
                       мы можем показывать фильмы без единого рекламного объявления, что оставляет
                       хорошее впечатление у зрителей. Потому что больше не нужно терпеть рекламу перед началом любимого
                       фильма.
                     </p>
                  <h3>Бесплатно и без регистрации</h3>
                  <p class="about__description_content">
                      Все мультфильмы на eKino доступны без регистрации и к тому же полностью бесплатные.
                      Теперь все что вам нужно это включить хороший мультфильм и наслаждаться просмотром в высоком качестве.
                  </p>
                </div> 
            </div>
        </div>
