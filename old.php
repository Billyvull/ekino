...
<head itemscope itemtype="http://schema.org/WPHeader">
    ...
    <title itemprop="headline">Ютуб Фильмы Без Рекламы 🎬 eKino</title>
        <!--------------------------------------------------------------------------------------->   
            ...
            <meta property="og:url" content="https://ekino.me/old" />
...
<div class="films">
    ...
    <div id="SortFilms" class="sort">
        ...
        <?php $singles = sort_index_old(); foreach ($singles as $single) { ?>
...
<?php $singles = get_pag_all(); foreach ($singles as $single) { ?><?php echo $single["pgold"]; ?> <?php } ?>
