...
<head itemscope itemtype="http://schema.org/WPHeader">
    ...
    <meta itemprop="keywords" name="keywords" content="Криминалы без рекламы, Ютуб криминалы, криминал фильмы 2021, смотреть онлайн, фильмы бесплатно">
    <meta itemprop="description" name="description" content="<?php 
        if(isset($_GET['page'])){ 
            echo 'Смотреть '. ((int) $_GET['page'])*25 .'+ ютуб фильмов в жанре Криминал без рекламы 2021 года. Мы отобрали самые недооцененные фильмы, которые стоит посмотреть всем любителям жанра Криминал. Просмотр полностью бесплатный!' ;}
        else { 
            echo 'Смотреть 100+ ютуб фильмов в жанре Криминал без рекламы 2021 года. Мы отобрали самые недооцененные фильмы, которые стоит посмотреть всем любителям жанра Криминал. Просмотр полностью бесплатный!' ; }?>">
<!------------------------------------------------------------------------------------------------------------------------>
...
<!------------------------------------------------------------------------------------------------------------------------>
    ...
    <link rel="shortcut icon" href="/img/favpuh.ico" type="image/x-icon">
            <!--------------------------------------------------------------------------------------->   
                 <meta property="og:title" content="Ютуб Криминал 🎬 eKino" />
                 <meta property="og:type" content="article">
                 <meta property="og:url" content="https://ekino.me/krimial" />
...
<!---------------------------------------------------- require: H1 ----------------------------------------------------->
            <h1>
                <?php 
                 if(isset($_GET['page'])){
                 echo 'Ютуб Криминал <sup style="font-size: 16px;color: #ccc;">(Топ '. ((int) $_GET['page'])*25 .')</sup>' ;
                 }
                 else {
                 echo 'Ютуб Криминал' ;
                 }
...
<!------------------------------------------------------------------------------------------------------------------------>
    <ul class="films__list" itemscope itemtype="http://schema.org/ItemList">
        <?php $singles = Криминал(); foreach ($singles as $single) { ?>
...
<!------------------------------------------------------------------------------------------------------------------------>
    ...
    <!-- ПАГИНАЦИЯ -->
    <?php $singles = category_pagination(); foreach ($singles as $single) { ?><?php echo $single["krimial"]; ?> <?php } ?>
    <!--------------->
            <div class="about">
                <h2>Криминал без рекламы</h2>
                <div class="about__description">
                  <p class="about__description_content">
                     Если вы ищете фильмы ютуб без рекламы в жанре Криминал, тогда добро пожаловать на eKino!
                     Сайт где собрана наибольшая подборка криминалов без надоедливой рекламы.
                     Для просмотра которых не нужно устанавливать блокировщики рекламы
                     или подобные программы удаления рекламных объявлений.
                 </p>
                 <br>
                  <p class="about__description_content">
                      Уже посмотрели все криминалы и не можете найти хорошее кино?
                      Мы отбираем самые недооцененные фильмы, которые вы захотите посмотреть.
                  </p>
                <h3>В хорошем качестве</h3>
                   <p class="about__description_content">
                       Сейчас на сайте много фильмов жанра криминал, которые стоит посмотреть каждому.
                   ...
                   <br>
                   <p class="about__description_content">
                       eKino публикует криминалы только в хорошем качестве: HD 720 и Full HD 1080.
