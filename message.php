	...
	<div class="sidebar">
		...
		<div class="sidebar">
			...
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
					<a href="https://ekino.me/message.php" class="sidebar__nav-link sidebar__nav-link--active"><ion-icon name="mail-outline"></ion-icon>&nbsp;&nbsp;Сообщения</a>
				</li>
				<li class="sidebar__nav-item">
		...
		<ul class="sidebar__nav">
			<li class="sidebar__nav-item">
				<a href="https://ekino.me/apanel.php" class="sidebar__nav-link sidebar__nav-link"><ion-icon name="pie-chart-outline"></ion-icon>&nbsp;&nbsp;Добавить фильм</a>
			</li>
			<li class="sidebar__nav-item">
			...
			<li class="sidebar__nav-item">
				<a href="https://ekino.me/message.php" class="sidebar__nav-link sidebar__nav-link--active" target="_blank"><ion-icon name="mail-outline"></ion-icon>&nbsp;&nbsp;Сообщения</a>
			</li>
			<li class="sidebar__nav-item">
					<a href="https://ekino.me/videoerror.php" class="sidebar__nav-link sidebar__nav-link"><ion-icon name="alert-circle-outline"></ion-icon>&nbsp;&nbsp;Проблемы</a>
				</li>
			...
			<div class="row">
							...
							<form action="messageedit" method="post">
							  <div> 
								<tr>
									...
									<td>
										<div class="main__table-text"><?php echo $film["email"]; ?></div>
										<input type="hidden" name="usermail" value="<?=$film["email"];?>">
									</td>
									<td>
										<div class="main__table-text"><a class="main__table-text main__table-btn--view open-modal"><?php echo $film["textmessage"]; ?></a></div>
									</td>
									<td>
									...
									<td>
										<div class="main__table-btns">
											<input type='submit' name='but1' class="form-input" value="Ответить">
				...
				<div class="col-12">
					<div class="paginator-wrap">
						<span>Сообщений: <?php echo maxmessage(); ?></span>
